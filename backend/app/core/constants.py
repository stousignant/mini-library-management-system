...
OPENAI_RATE_LIMIT_DELAY_SECONDS = 0.5
AI_SUMMARY_PROMPT_TEMPLATE = """Generate a compelling and informative book summary for "{title}" by {author}.

The summary should:
- Be engaging and capture the essence of the book
- Be 100-300 words in length
- Highlight key themes, plot points (without major spoilers), or concepts
- Be written in an accessible, engaging style
- Focus on what makes this book significant or interesting
...
Provide only the summary text, without any preamble or formatting."""
